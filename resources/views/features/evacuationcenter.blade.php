                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                @foreach ($approvedevacs as $approvedevac)
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <strong>{{ $approvedevac->evac_name }}</strong>
                                            </h5>
                                            <h6 class="card-subtitle mb-2 text-muted">
                                                {{ $approvedevac->brgy_loc }}
                                            </h6>
                                            <p class="card-text">
                                            <div class="content">
                                                <i class="fas fa-directions mr-2 color"></i> <span
                                                    class="text-primary font-weight-bold"> Nearest Landmark:</span>
                                                {{ $approvedevac->nearest_landmark }}
                                            </div>

                                            <div class="content">
                                                <i class="fas fa-phone-square-alt mr-2 color"></i> <span
                                                    class="text-primary font-weight-bold">Contact Number:</span>
                                                {{ $approvedevac->phone_no }}
                                            </div>
                                            ...
                                            <div class="content">
                                                <i class="fas fa-users mr-2 color"></i> <span
                                                    class="text-primary font-weight-bold">Capacity:</span>
                                                {{ $approvedevac->capacity }}
                                            </div>


                                            <div class="content">
                                                @if ($approvedevac->availability === 'Available')
                                                    <span
                                                        class="badge badge-success">{{ $approvedevac->availability }}</span>

                                                @else
                                                    <span
                                                        class="badge badge-danger">{{ $approvedevac->availability }}</span>

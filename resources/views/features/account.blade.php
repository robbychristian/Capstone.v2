                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="fname"
                                        class="form-control @error('fname') is-invalid @enderror" id="inputfName"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="mname"
                                        class="form-control @error('mname') is-invalid @enderror" id="inputmName"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="lname"
                                        class="form-control @error('lname') is-invalid @enderror" id="inputlName"

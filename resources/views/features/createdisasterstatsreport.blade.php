                ...
                @endif
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="text-danger">@error('typeOfdisaster')
                                    {{ $message }}
                                @enderror</div>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="text-danger">@error('dayOfdisaster')
                                    {{ $message }}
                                @enderror</div>
                        </div>
                        <div class="form-group col-md-2">
                    ...
                    <div id="dynamicAddRemove">
                        <div class="form-row">
                            <div class="form-group col-12 col-md-4">
                                ...
                                <div class="text-danger">@error('addMoreInputFields.*.street')
                                    {{ $message }}
                                @enderror</div>
                            </div>
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <div class="text-danger">@error('addMoreInputFields.*.families')
                                    {{ $message }}
                                @enderror</div>
                            </div>

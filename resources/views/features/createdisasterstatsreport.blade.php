                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select id="day" class="form-control mt-2" id="inputDay" placeholder="Day" name="dayOfdisaster"
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control mt-2" id="inputYear" placeholder="Year" name="yearOfdisaster"
        ...
        <script type="text/javascript">
            ...
            $("#dynamic-ar").click(function() {
                ...
                $("#dynamicAddRemove").append(
                    ...
                    i +
                    '][street]" class="form-control" /> <div class="text-danger">@error('addMoreInputFields.*.street'){{ $message }}@enderror</div></div><div class="form-group col-12 col-md-4"> <input type = "text" name = "addMoreInputFields[' +
                    i +
                    '][families]" class = "form-control"/> <div class="text-danger">    @error('addMoreInputFields.*.families'){{ $message }}@enderror</div></div> <div class = "form-group col-6 col-md-4" ><button type = "button" name = "add" id = "dynamic-ar" class="btn btn-outline-danger form-control remove-input-field">Delete </button> </div></div>'
                );
            });

                            ...
                            <div class="card-body">
                                ...
                                <div class="content mb-2">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="row">
                                                <div class="col-sm-3" style="font-weight: 500;">Type</div>
                                                <div class="col-sm-9"> {{ $disasterstats->type_disaster }}</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="row">
                                                <div class="col-sm-3" style="font-weight: 500;">Name</div>
                                ...
                                <div class="content mb-2">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="row">
                                                <div class="col-sm-3" style="font-weight: 500;">Date</div>
                                                <div class="col-sm-9"> {{ $disasterstats->month_disaster }}
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9"> {{ $disasterstats->barangay }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

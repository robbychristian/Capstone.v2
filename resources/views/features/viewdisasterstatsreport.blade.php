                            ...
                            <div class="card-body">
                                ...
                                <div class="content mb-2">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-sm-4 col-md-4 col-lg-3" style="font-weight: 500;">Type:</div>
                                                <div class="col-sm-8 col-md-8 col-lg-9"> {{ $disasterstats->type_disaster }}</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="row">
                                                <div class="col-sm-4 col-lg-3" style="font-weight: 500;">Name:</div>
                                                <div class="col-sm-8 col-lg-9"> {{ $disasterstats->name_disaster }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content mb-2">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-sm-4 col-md-4 col-lg-3" style="font-weight: 500;">Date:</div>
                                                <div class="col-sm-8 col-md-8 col-lg-9"> {{ $disasterstats->month_disaster }}

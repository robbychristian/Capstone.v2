                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($report->status == 'Report Pending')
                                        <span class="badge badge-pill badge-warning" style="font-size: 0.5rem;"> {{ $report->status }}</span>
                                    @else
                                    <span class="badge badge-pill badge-success" style="font-size: 0.5rem;"> {{ $report->status }}</span>
                                    @endif

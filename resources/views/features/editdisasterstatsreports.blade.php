                            ...
                            @section('content')
                                ...
                                <div class="container-fluid" style="color: black">
                                    <h1 class="h3 mb-4 text-gray-800">Edit Disaster Statistical Report</h1>
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @if (Auth::user()->user_role === 1)
                                                <form action="/admin/stats/{{ $disasterstats->id }}" method="POST">
                                                @elseif (Auth::user()->user_role === 3)
                                                    <form action="/brgy_official/stats/{{ $disasterstats->id }}"
                                                        method="POST">
                                            @endif
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="barangay" type="text" class="form-control" id="inputAddress"
                                                        value="{{ $disasterstats->barangay }}" readonly>
